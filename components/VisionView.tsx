    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl space-y-6">
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl p-4 text-slate-100 min-h-[120px] focus:ring-2 focus:ring-emerald-500/50 outline-none transition-all"
              />
            </div>
        ...
        <div className="lg:col-span-2">
          <div className="aspect-square lg:aspect-video bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden relative flex items-center justify-center">
            {generatedImage ? (
            ...
            {isGenerating && (
              <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm flex flex-col items-center justify-center space-y-4">
                ...
                <p className="text-emerald-400 font-medium animate-pulse">Refining pixels...</p>
              </div>
            )}
          </div>
          {generatedImage && (
             <div className="mt-4 flex justify-end">
                <a 
                  ...
                  className="px-6 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg text-sm transition-all"
                >
                  Download Asset
                </a>
             </div>
